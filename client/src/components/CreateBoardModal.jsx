        ...
        <div className="fixed inset-0 bg-black/15 z-50 flex items-center justify-center" onClick={handleClose}>
            ...
            >
                ...
                <form action={CreateBoard} className="flex flex-col gap-2">
                    ...
                    <input name="title" type="text" placeholder="Enter board title..."className="border border-gray-300 p-1 pl-2 rounded-lg" required/>
                    <label className="text-sm font-medium mt-2 text-gray-700">Image</label>
                    <div className="flex gap-3 items-center rounded-lg">
                        <input name="image" placeholder="Search for image" type="text" className="border border-gray-300 p-1 pl-2 w-11/12 rounded-lg" autoComplete="off" required/>
                    ...
                    <select name="category" className="text-gray-700 border border-gray-300 p-1 rounded-lg mt-1" required>
                    ...
                    <input placeholder="Optional" name="author" type="text" className="border border-gray-300 text-1xl p-1 pl-2 rounded-lg"></input>
